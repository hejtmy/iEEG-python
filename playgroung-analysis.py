...
# Epoching
epochs = mne.Epochs(eeg, mne_events, event_id=events_mapp, tmin=-1, tmax=3)
...
morlet['onsets_500_1500'].plot_topo(picks=pick_all, layout=box,
                                    mode='logratio', baseline=(-1, -0.5))
morlet['onsets_500_1500'].plot(110, baseline=(-1, -0.5), mode='logratio')
