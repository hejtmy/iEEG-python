...
power_onset_original_vr = tfr_morlet(epochs_original_vr['onsets_500_1500'], freqs=freqs, n_cycles=n_cycles,
                                    picks=picks_original, return_itc=False)
# NEED to pass picks because default IGNORES SEEG channels
power_onset_original_vr.plot_topo(picks=plot_picks_perhead, baseline=(-2., -1.5), mode='logratio', layout=box)