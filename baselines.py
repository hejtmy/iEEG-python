...
power_onset_perhead_vr.apply_baseline(baseline = baseline, mode = mode)
power_stop_perhead_vr.apply_baseline(baseline = baseline, mode = mode)

power_trials_onset_perhead_vr.apply_baseline(baseline = baseline, mode = mode)
power_trials_stop_perhead_vr.apply_baseline(baseline = baseline, mode = mode)

power_point_perhead_vr_ego.apply_baseline(baseline = baseline, mode = mode)
power_point_perhead_vr_allo.apply_baseline(baseline = baseline, mode = mode)
